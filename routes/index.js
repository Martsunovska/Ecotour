...
router.get("/setup-db", function(reg, res) {
    var countries = [{
        ...
        {
            Name: "НІДЕРЛАНДИ",
            Desc: "Нідерла́нди (нід. Nederland, МФА: [ˈneːdərˌlɑnt]) — країна на заході Європи на березі Північного моря. Частина, офіційно Королі́вства Нідерла́ндів (нід. Koninkrijk der Nederlanden), котре складається з західноєвропейської території та Карибських островів Бонайре, Саба та Сінт-Естатіус, разом з островами Аруба, Кюрасао та Сінт-Мартен (які мають особливий статус). Часто країну неофіційно називають Голландією за назвою однієї з семи провінцій, що спочатку входила в Республіку Сполучених провінцій Нідерландів у XVI столітті.",
            Image: "/images/Nederland.jpg"
        },
        {
            Name: "ШОТЛАНДІЯ",
            Desc: "Шотла́ндія — країна, частина Об'єднаного Королівства[1][2][3], колись незалежна держава. Займає північну частину Великої Британії, на півдні межує з Англією, на сході її береги омиває Північне море, на півночі й заході Атлантичний океан, на південному заході — Північна протока та Ірландське море. Окрім того, Шотландія складається ще із близько 790 островів[4], серед яких архіпелаги Шетландські, Оркнейські та Гебридські острови.",
